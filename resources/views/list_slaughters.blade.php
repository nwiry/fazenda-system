...
<div class="col-lg-12">
    <div class="card">
        <h5 class="card-header">Animais Abatidos</h5>
        <div class="card-body">
            <table id="table_animals" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
                        <th>#</th>
                        <th>Código</th>
                        <th>Leite Produzido (Semanalmente)</th>
                        <th>Ração Ingerida (Semanalmente)</th>
                        <th>Peso</th>
                        <th>Nascimento</th>
                    </tr>
                </thead>
...
let table = $('#table_animals').DataTable({
    responsive: true,
    "stripeClasses": [],
    "ajax": "/api/v1/list_cattle_slaughters",
    "processing": true,
    "serverSide": false,
    "paging": true,
    "columns": [{
